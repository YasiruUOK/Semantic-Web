...
export class HomeComponent {
  ...
  brandNames: string[] = ["Toyota", "Suzuki", "Nissan", "Honda"];
  modelNames: string[] = ["Vitz", "Corolla", "Axio", "Premio", "Aqua", "Yaris", "CHR", "Allion", "Alto", "Swift", "Wagon R Stingray", "Maruti", "Wagon R", "Wagon R FZ", "Trad Sunny", "March k11", "X-Trail", "Leaf", "Vezel", "Fit", "Civic", "CRV"];
  modelyearsFrom: string[] = ["2019", "2018","2017", "2016", "2015", "2014","2013", "2012", "2010", "2008","2007", "2004", "2003","2001", "2000","1996","1994", "1987", "1986"];
  modelyearsTo: string[] = ["2019", "2018","2017", "2016", "2015", "2014","2013", "2012", "2010", "2008","2007", "2004", "2003","2001", "2000","1996","1994", "1987", "1986"];

  selectedRange = -1;
  selectedBrand: string = "";
  selectedModel: string = "";
  selectedModeYearFrom: string = "";
  selectedModeYearTo: string = "";
  ...
  async query1clicked() {
    if(this.selectedBrand==""){
      var query1 = `PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Brand ?Model ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand ?Brand.
        ?car ikman:Model ?Model .
        ?car ikman:ModelYear ?ModelYear .
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
        ?car ikman:EngineCapacity ?EngineCapacity .
        ?car ikman:Mileage ?Mileage .
        ?car ikman:Price ?Price .
      }`
    }else{
      var query1 = `PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Model ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand "`+ this.selectedBrand + `".
        ?car ikman:Model ?Model .
        ?car ikman:ModelYear ?ModelYear .
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
      ...
      //this.specialneeds=await fetch(this.sparqlEndpoint, { "credentials": "include", "referrer": "http://localhost:3030/dataset.html?tab=query&ds=/ds", "referrerPolicy": "no-referrer-when-downgrade", "body": encodedQuery1, "method": "POST", "mode": "cors" }).then(res => res.json());
  ...
  async query2clicked() {
    ...
    if(this.selectedBrand=="" && this.selectedModel==""){
      var query2 = `PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Brand ?Model ?ModelYear ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand ?Brand.
        ?car ikman:Model ?Model .
        ?car ikman:ModelYear ?ModelYear .
      ...
      var query2 = ` PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Brand ?ModelYear ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand ?Brand.
        ?car ikman:Model "`+ this.selectedModel + `".
        ?car ikman:ModelYear ?ModelYear .
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
        ?car ikman:EngineCapacity ?EngineCapacity .
  ...
  `
      ...
      var query2 = ` PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?ModelYear ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand "`+ this.selectedBrand + `".
        ?car ikman:Model "`+ this.selectedModel + `".
        ?car ikman:ModelYear ?ModelYear .
  ...
  async query3clicked() {
    ...
    if(this.selectedModeYearTo=="" && this.selectedBrand==""){
      var query3 = `PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Brand ?Model ?ModelYear ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand ?Brand.
        ?car ikman:Model ?Model .
  ?car ikman:ModelYear ?ModelYear .
  FILTER (?ModelYear >= "`+ this.selectedModeYearFrom + `" )
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
        ?car ikman:EngineCapacity ?EngineCapacity .
        ?car ikman:Mileage ?Mileage .
  ...
  `
    }else if(this.selectedModeYearFrom=="" && this.selectedBrand==""){
      var query3 = `PREFIX ikman: <https://ikman.lk/en/ads/sri-lanka/cars#> 
      SELECT ?Brand ?Model ?ModelYear ?Transmission ?BodyType ?EngineCapacity ?Mileage ?Price
      WHERE
      { ?car ikman:Brand ?Brand.
        ?car ikman:Model ?Model .
  ?car ikman:ModelYear ?ModelYear .
  FILTER (?ModelYear <= "`+ this.selectedModeYearTo + `" )
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
        ?car ikman:EngineCapacity ?EngineCapacity .
        ?car ikman:Mileage ?Mileage .
  ...
  `
      ...
      ?car ikman:Model "`+ this.selectedModel + `".
  ?car ikman:ModelYear ?ModelYear .
  FILTER (?ModelYear >= "`+ this.selectedModeYearFrom + `" && ?ModelYear <= "`+ this.selectedModeYearTo + `")
        ?car ikman:Transmission ?Transmission .
        ?car ikman:BodyType ?BodyType .
        ?car ikman:EngineCapacity ?EngineCapacity .
        ?car ikman:Mileage ?Mileage .
